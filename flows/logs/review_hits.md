...
#### Reddit r/backgammon
- WebFetch不可（Claude Code制限）→ WebSearch補完
  - 具体的な最新投稿の取得不可
  - コミュニティは継続活発（2026年もアクティブな状態）

#### Backgammon Forums（backgammonforums.com）
- WebFetch 403 → WebSearch補完
  - フォーラム継続中（2026年4月時点でアクティブ）

#### BGonline.org Forums
- WebSearch確認
  - 累計214,596メッセージ（週約73投稿ペース）
  - 専門的な盤面検討（Position of the Day）が継続して活発

#### Backgammon Galaxy YouTube（@BackgammonGalaxy）
- WebSearch確認（https://www.youtube.com/@BackgammonGalaxy/videos）
  - 登録者34.2K（2018年6月開設）
  - 注目動画：
    - 「The Mochy Challenge - Match 7 and 8」（Backgammon Galaxy公式）
    - 「Mochy vs Yoshi 25p match」（明仁戦・25点マッチ、準決勝）
  - 新刊連動：Kageyama vs Mochizuki戦の動画コンテンツ関連あり

#### Mochy公式ブログ（blog.goo.ne.jp/mochy3_8）
- WebSearch確認（Mochy's Backgammon Today）
  - 最新情報：WebSearch経由で「Backgammon Grandmaster Match: Michy vs Mochy」告知あり
  - ブログ継続更新中

#### その他コンテンツ
- U.S. Backgammon Federation：初心者向け動画シリーズ継続公開
- 2026 NY Metropolitan Open / Texas Backgammon Championships：ライブ配信実施済み
- Backgammonmaster（backgammonmaster.nl）：動画解説継続中
